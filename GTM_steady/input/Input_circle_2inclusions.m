...
% Name of output file
PROBLEM.General.SaveName = 'circle_2_inclusions';
% SaveMode
...
% PROBLEM.Electrode.delete_electrodes={[-0.25 0.5;0.25 -0.5];...
%                                      [-0.5 0.25;0.5 -0.25]};
...
% PROBLEM.Electrode.delete_measurements={[-0.25 0.5;-0.25 -0.5;0.25 -0.5;0.25 0.5];...
%                                        [-0.5 0.25;-0.5 -0.25;0.5 -0.25;0.5 0.25]};
PROBLEM.Electrode.delete_measurements={[-0.5 0.7;-0.5 -0.5;0.6 -0.5]};
...
PROBLEM.LoadDef.BC = {[-0.5 0.5;-0.5 -0.5;0.6 -0.5],'transfer',30,1e1;... left boundary
                      [-0.5 0.7;0.6 0.7;0.6 -0.5],'transfer',15,1e1};% outer left boundary
