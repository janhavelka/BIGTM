...
% Name of output file
PROBLEM.General.SaveName = 'l_shape_time';
% SaveMode
...
PROBLEM.Electrode.delete_electrodes={[0.0 1.0;0.0 0.6];...
                                     [0.6 0.0;1.0 0.0;0.5 0.6;0.6 0.0]};
...
PROBLEM.LoadDef.BC = {[0.0 0.6;0.6 0.6],'transfer',25,1e1;... inner left boundary
                      ...
                      [1.0 0.0;1.0 1.0],'transfer',5,1e1;... outer right boundary
                      [1.0 1.0;0.0 1.0],'transfer',5,1e1};% outer left boundary
