function LOAD = GTM_getLoad( MESH,PROBLEM,MATERIAL )
...
% get capacity matrix
[LOAD,eval_time] = GTM_getCapacity(MESH,PROBLEM,LOAD,MATERIAL.rho.*MATERIAL.c);

% identify the actual nodes where one takes measurements
[LOAD,eval_time]=GTM_getMeasurementBoundary(MESH,PROBLEM,LOAD);
